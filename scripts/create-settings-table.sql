-- ГРАФИН — таблица настроек ресторана.
-- Запусти ОДИН раз в Supabase: SQL Editor → New query → вставь → Run.
-- (Storage bucket dish-photos уже создан программно — здесь только таблица.)
